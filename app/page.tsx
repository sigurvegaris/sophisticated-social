      ...
      >
        ...
        <div style={{
          ...
          {[
            ...
            { quote: "Emmy has taste. She is also like lightening when she does social media; instantly filled with ideas that all make sense, skilled with the technicalities, responsive to the needs of the businesses she helps, absolutely willing to do the best thing. I'm so glad to have her on my team.", name: 'Susan Herrmann Loomis', title: 'Cookbook Author and Cooking School Chef' },
